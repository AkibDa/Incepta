...
def enhance_prompt(prompt):
    print("\n⏳ Enhancing prompt...")
    prompt_enhancer = pipeline("text2text-generation", model="google/flan-t5-large", device=0 if torch.cuda.is_available() else -1)
...
if __name__ == "__main__":
    # Optional: remove memory limits on MPS (use at your own risk)
